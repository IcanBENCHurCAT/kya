...
- [ ] Task 1.1: Create Supabase SQL Migration Script [File: `db/migrations/002_karma_ledger.sql`]
...
- [ ] Task 2.1: Implement `InMemoryKarmaStore` [File: `src/services/karma.ts`]
...
- [ ] Task 2.2: Implement Core `KarmaService` Class [File: `src/services/karma.ts`]
...
- [ ] Task 3.1: Implement Payment Challenge Generator [File: `src/middleware/x402.ts`]
...
- [ ] Task 3.2: Implement On-Chain Algorand Payment Verification & Replay Protection [File: `src/middleware/x402.ts`]
...
- [ ] Task 3.3: Implement Exempt Route Filtering [File: `src/middleware/x402.ts`]
...
- [ ] Task 4.1: Implement Karma REST Endpoints [File: `src/routes/karma.ts`]
...
- [ ] Task 4.2: Wire Middleware & Routes in App Gateway [File: `src/app.ts`]
...
- [ ] Task 5.1: Create Karma Service Unit & Integration Tests [File: `__tests__/karma.test.ts`]
...
- [ ] Task 5.2: Create x402 Payment Middleware Tests [File: `__tests__/x402.test.ts`]
...
- [ ] Task 6.2: Execute TypeScript Build Check [Command: `npm run build`]
