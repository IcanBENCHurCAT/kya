...
- [x] Task 1.1: Define `OnChainKarmaBox` Interface & Binary Offsets [File: `src/algorand/box-layout.ts`]
...
- [x] Task 1.2: Implement `encodeKarmaBox` & `decodeKarmaBox` Binary Serializer Functions [File: `src/algorand/box-layout.ts`]
...
- [x] Task 2.1: Define ZK Proof Data Models & Verification Interfaces [File: `src/services/zkp.ts`]
...
- [x] Task 2.2: Implement `ZKPVerifierService` Class [File: `src/services/zkp.ts`]
...
- [x] Task 3.1: Define A2A Pre-Flight & W3C Verifiable Credential Schemas [File: `src/services/a2a.ts`]
...
- [x] Task 3.2: Implement `A2AService` Handshake Evaluator & Signer [File: `src/services/a2a.ts`]
...
- [x] Task 4.1: Implement Groth16 ZK-KYC REST Route [File: `src/routes/zk-proof.ts`]
...
- [x] Task 4.2: Implement A2A Pre-Flight Handshake REST Route [File: `src/routes/a2a.ts`]
...
- [x] Task 4.3: Wire ZK-KYC & A2A Routes into App Gateway [File: `src/app.ts`]
...
- [x] Task 5.1: Create Algorand 77-Byte Box Layout Unit Tests [File: `__tests__/box-layout.test.ts`]
...
- [x] Task 5.2: Create Groth16 ZK-KYC Proof Verifier Tests [File: `__tests__/zkp.test.ts`]
...
- [x] Task 5.3: Create A2A Pre-Flight Handshake Tests [File: `__tests__/a2a.test.ts`]
...
- [x] Task 6.2: Execute TypeScript Type Check & Build [Commands: `npm run typecheck`, `npm run build`]
